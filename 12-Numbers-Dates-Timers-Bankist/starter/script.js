...
btnLoan.addEventListener('click', function (e) {
  ...
  //  round it down, the method will type coercion so no need for the + that converts to number:
...
// console.log(Number.parseInt('30erm'));

// console.log(Number.isNaN(30));
// console.log(Number.isNaN('30'));
// console.log(Number.isNaN(+'30n'));
// console.log(Number.isNaN(23 / 0));
// console.log('---------------');
// console.log(Number.isFinite(30));
// console.log(Number.isFinite('30'));
// console.log(Number.isFinite(+'30n'));
...
// console.log(2 ** 53 + 1);
// console.log(2 ** 53 + 3);
// console.log(456795674564576785673452342454575763452435345464n);

// const now = new Date();
// console.log(now);

// console.log(new Date('Nov 20 2021 09:28:40'));
// console.log(new Date('June 25 1966'));
